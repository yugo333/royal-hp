...
**概要:**  
Three.jsとBARのロゴを使用して背景にキャンバスタグの3Dと前面にロゴが配置されるようにする。構成自体はシンプルだが3Dの部分はGLSLを活用して、リッチな見開きの画面にする。マウス操作で背景が変わるような機能は不要。
...
- `royal-hp/public/MainPic/` または `asset/SubPic/` 配下の画像を使用
...
https://share.google/5y1JPqqJMesrY9wQV
