...
| 用途                 | RGB値              |
| -------------------- | ------------------ |
| 背景ベースカラー     | RGB(22, 33, 39)    |
| 部品や文字（メイン） | RGB(207, 157, 123) |
| 部品や文字（サブ1）  | RGB(114, 75, 57)   |
| 部品や文字（サブ2）  | RGB(58, 53, 52)    |

> **注意事項**
>
> - 文字は基本RGB(207, 157, 123)にしたい
> - 他に色を使用したい場合はRGB(12, 21, 25)を使用する
...
**概要:**
Three.jsとBARのロゴを使用して背景にキャンバスタグの3Dと前面にロゴが配置されるようにする。構成自体はシンプルだが3Dの部分はGLSLを活用して、リッチな見開きの画面にする。マウス操作で背景が変わるような機能は不要。指定されたGLSLシェーダーを忠実に再現する。

**使用画像:**

- `royal-hp/public/logo/` 配下の画像を使用

**参考デザイン:**

- `royal-hp/public/メインページサンプル.jpg`
- ※参考デザインはあくまでイメージで、ホーム画面は3Dとする

### MENU画面

**概要:**
お酒のメニューと料金形態がわかるようにする。

**使用画像:**

- `royal-hp/public/MainPic/` または `royal-hp/public/SubPic/` 配下の画像を使用

**参考デザイン:**

- `royal-hp/public/メニュサンプル.jpeg`

**メニュー内容:**

- public/RoyalMenu.csv お店のメニュです（テーブルチャージは無しです）

### STAFF画面

**概要:**
シンプルに白黒のstaffの写真と名前のみを一覧で表示する

**使用画像:**

- `royal-hp/public/Staff/` 配下の画像を使用

**参考デザイン:**

- `royal-hp/public/スタッフリストサンプル.jpg`

### ACCESS画面

**概要:**
お店の住所とGoogleマップと電話番号、営業時間を表示する
...
**所在地:** 〒134-0088 東京都江戸川区西葛西３丁目１５−１０ ６東栄ビル 6 階

**電話番号:** 070-1322-8595

**営業時間:**

- 土曜日 0時00分～6時00分, 20時00分～0時00分
- 日曜日 0時00分～6時00分, 20時00分～0時00分
- 月曜日 0時00分～6時00分, 20時00分～0時00分
- 火曜日 0時00分～6時00分, 20時00分～0時00分
- 水曜日 0時00分～6時00分, 20時00分～0時00分
- 木曜日 0時00分～6時00分, 20時00分～0時00分
- 金曜日 0時00分～6時00分, 20時00分～0時00分

**Googleマップ:** https://share.google/5y1JPqqJMesrY9wQV
...
## HOME画面 3D Three.js実装

### 参考リソース

**参考URL:**
https://glslsandbox.com/e#109020.0

**参考コード（Three.jsで忠実に再現したい）:**
...
- https://threejs.org/examples/#webgpu_tsl_raging_sea
- https://glslsandbox.com/e#109609.0
- https://glslsandbox.com/e#109446.0
- https://glslsandbox.com/e#109266.0
